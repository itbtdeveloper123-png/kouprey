...
const DEFAULT_SETTINGS_KM = {
  ...
  nav_about: 'អំពីយើង',
  about_title: 'អំពី កូព្រៃ គ្រឿងបន្ថែមរស់ជាតិ (KouPrey)',
  about_content: 'នេះជាការចាប់ផ្តើមនៃ KouPrey។ បន្ទាប់ពីបានភ្លក់រសជាតិគ្រឿងបន្ថែមរស់ជាតិដ៏បរិសុទ្ធបំផុតនៅលើជម្រាលភ្នំ យើងបានប្រឹងប្រែងស្វែងរកអ្វីដែលស្រដៀងគ្នានេះនៅពេលត្រឡប់មកវិញ — ដូច្នេះហើយយើងបានសម្រេចចិត្តបង្កើតវាដោយខ្លួនឯង។',
  about_explore_button: 'ស្វែងរក',
  about_purpose_title: 'គោលបំណងរបស់យើង',
  about_purpose_content: 'នៅ KouPrey យើងធ្វើអ្វីៗខុសពីគេ — ដោយមានគោលបំណង។ គោលដៅរបស់យើងសាមញ្ញ៖ ធ្វើឱ្យគ្រឿងបន្ថែមរស់ជាតិសរីរាង្គ មានសុខភាព និងឆ្ងាញ់អាចរកបានសម្រាប់មនុស្សជាច្រើនតាមដែលអាចធ្វើទៅបាន។ យើងប្តេជ្ញាចិត្តផ្តល់គ្រឿងបន្ថែមរស់ជាតិដែលល្អជាងសម្រាប់អ្នក សហគមន៍ និងភពផែនដីរបស់យើង។',
  about_mission_title: 'រឿងរ៉ាវរបស់យើង',
  about_mission_content: 'យើងចាប់ផ្តើមដោយស្រឡាញ់គ្រឿងបន្ថែមរស់ជាតិស្អាត និងបំណងចង់ចែករំលែកវា។ ក្នុងរយៈពេលជាច្រើនឆ្នាំ យើងបានសហការជាមួយអ្នកផ្តល់ បង្កើតការដុតរបស់យើង និងពង្រីកជួររបស់យើង — ទាំងអស់នេះខណៈពេលដែលរក្សាគុណភាព និងចីរភាពនៅខ្លឹមសារនៃអ្វីៗទាំងអស់ដែលយើងធ្វើ។',
  features_title: 'លក្ខណៈពិសេស',
  features_description: 'ស្វែងរកអ្វីដែលធ្វើឱ្យគ្រឿងបន្ថែមរស់ជាតិរបស់យើងពិសេស — ចាប់ពីការស្វែងរក ដល់ការដុត និងការវេចខ្ចប់។',
  reviews_title: 'ពិនិត្យរបស់អតិថិជន',
  reviews_description: 'អានពីរបៀបដែលអតិថិជនចូលចិត្តគ្រឿងបន្ថែមរស់ជាតិ និងផលិតផលរបស់យើង។',
  ...
  hero_subtitle: 'ផលិតផលគ្រឿងបន្ថែមរស់ជាតិ និងតែបៃតងធម្មជាតិ លំដាប់ពិសេស ផ្តល់នូវថាមពល និងភាពស្រស់ស្រាយពេញមួយថ្ងៃ។',
  syrup_collection_title: 'បណ្តុំសុីរ៉ូសម្រិតសម្រាំង',
  syrup_collection_desc: 'បង្កើនឱជារសភេសជ្ជៈរបស់អ្នកជាមួយសុីរ៉ូធម្មជាតិដ៏ឈ្ងុយឆ្ងាញ់របស់យើង។ បង្កើតឡើងយ៉ាងផ្ចិតផ្ចង់ ដើម្បីនាំមកនូវភាពស្រស់បំព្រងដល់គ្រឿងបន្ថែមរស់ជាតិ ស្រាក្រឡុក និងបង្អែមគ្រប់មុខ។',
  explore_syrups: 'ស្វែងរកសុីរ៉ូ',
  powder_selection_title: 'បណ្តុំម្សៅគុណភាពខ្ពស់',
  powder_selection_desc: 'បង្កើតនូវភេសជ្ជៈដ៏ឈ្ងុយឆ្ងាញ់ និងមានរសជាតិរលូនជាមួយម្សៅតែបៃតង និងគ្រីមម៉ាធម្មជាតិរបស់យើង។ ស័ក្តិសមទាំងសម្រាប់ហាងគ្រឿងបន្ថែមរស់ជាតិអាជីព និងការឆុងទទួលទាននៅផ្ទះ។',
  ...
  location_desc: 'សូមអញ្ជើញមកទទួលយកបទពិសោធន៍ក្លិនក្រអូប និងរសជាតិគ្រឿងបន្ថែមរស់ជាតិគុណភាពខ្ពស់របស់យើងដោយផ្ទាល់។',
