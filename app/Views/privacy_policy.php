...
<body class="bg-white text-gray-800 font-freeman min-h-screen pb-20 flex flex-col">
    ...
    <main class="max-w-4xl mx-auto px-4 md:px-6 py-8 md:py-12">
        ...
        <?php if (!empty($privacyContent)): ?>
            ...
            <div class="prose max-w-none policy-section">
                <?php echo nl2br(htmlspecialchars($privacyContent)); ?>
            </div>
        <?php else: ?>
                ...
                <div>
                    ...
                    <div class="flex space-x-4 mb-6">
                        <?php if (getSetting('enable_social_links', '1') === '1'): ?>
                            ...
                            <a href="#" class="text-gray-300 hover:text-pink-400 transition-colors"><i class="fab fa-tiktok text-xl"></i></a>
                            <a href="#" class="text-gray-300 hover:text-blue-500 transition-colors"><i class="fab fa-telegram-plane text-xl"></i></a>
                        <?php endif; ?>
                    </div>
